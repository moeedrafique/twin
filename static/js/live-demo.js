var templates = {
  ...
  <div class="control">
    <input type="text" style="width: 340px;" name="date-in" class="input form-control mb-1 date">
  </div>
</div>`,
  inline: `<div class="date" name="date"></div>`,
  range: `<div style="display: flex;" class="field has-addons date">
    <div class="col-sm-6"><input type="text" class="input form-control mb-1" placeholder="" name="range-start"></div>
    <div class="col-sm-6"><input type="text" class="input form-control mb-1" placeholder="" name="range-end"></div>
</div>`,
};
var buttonClass;
