...
class UserProfile(models.Model):
    ...
    id_card_no = models.CharField(max_length=255,default=None)
    # nationality = CountryField(default=None, null=True, blank_label="Select Country")
    ...
    house_address = models.CharField(max_length=255,default=None)
    phone_number = models.CharField(max_length=255,default=None)
    landline = models.CharField(max_length=255,default=None, null=True)
    emergency_contact = models.CharField(max_length=255,default=None)
...
def create_user_profile(sender,instance,created,**kwargs):
    if created:
        UserProfile.objects.create(auth_user_id=instance,dob="",id_card_no=""
                                   , house_address="", phone_number="", emergency_contact=""
                                 ,medical_history="")
